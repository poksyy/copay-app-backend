...
public class UserController {
	...
	public ResponseEntity<?> updateUser(@PathVariable Long id,
			@Valid @RequestBody UserRegisterRequest userRegisterRequest, BindingResult result) {
	...
	public ResponseEntity<List<UserResponseDTO>> getAllUsers() {
		...
		List<UserResponseDTO> responseDTOs = users.stream().map(UserResponseDTO::new).collect(Collectors.toList());
